...
> mydjin自己没怎么接触人工智能，结合网上很多大神的资料整理而成，也有一定参考意义。
...
开源项目 `awesome-python-cn`（地址：https://github.com/jobbole/awesome-python-cn） 和 `awesome-python`（地址：https://github.com/vinta/awesome-python）已经帮大家整理了各方向的 Python 类库，数量非常多。mydjin在此基础上筛选了一些相对优质的库，分享给大家。
...
- mydjin公众号【程序员mydjin】后台回复 Python，也有一套视频课
